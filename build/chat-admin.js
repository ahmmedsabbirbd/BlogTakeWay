(function(){"use strict";const He="modulepreload",Je=function(e){return"/"+e},qe={},se=function(o,i,r){let l=Promise.resolve();function d(p){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=p,window.dispatchEvent(u),!u.defaultPrevented)throw p}return l.then(p=>{for(const u of p||[])u.status==="rejected"&&d(u.reason);return o().catch(d)})};(function(){let e={promoBars:[],loading:!0,activeTab:"manage"},o=null;function i(y){if(o=document.getElementById(y),!o){console.error("Container not found:",y);return}r(),window.promobarxAdmin&&window.promobarxAdmin.ajaxurl&&window.promobarxAdmin.nonce?l():(console.log("Admin data not available"),e.loading=!1,m())}function r(){o.innerHTML=`
        ...
        `}window.simpleTopBarManager={init:i,loadPromoBars:l,deletePromoBar:d,toggleStatus:p,createNew:u,editPromoBar:c,switchTab:s}})(),document.addEventListener("DOMContentLoaded",()=>{try{let e=function(c){const a=new URLSearchParams(window.location.search).get("id");console.log("Simple Editor: URL params:",window.location.search),console.log("Simple Editor: Promo bar ID from URL:",a),c.innerHTML=`
            ...
            `,o(),a&&(console.log("Simple Editor: Loading promo bar data for ID:",a),loadPromoBarData())},o=function(){const c=document.getElementById("promo-countdown-enabled"),s=document.getElementById("promo-countdown-date");c&&c.addEventListener("change",function(){s.style.display=this.checked?"block":"none",i()}),["promo-name","promo-title","promo-subtitle","promo-cta-text","promo-cta-url"].forEach(m=>{const h=document.getElementById(m);h&&h.addEventListener("input",i)}),["promo-bg-color","promo-text-color","promo-cta-color","promo-font-size","promo-position"].forEach(m=>{const h=document.getElementById(m);h&&h.addEventListener("change",i)}),i()},i=function(){var x,j,N,P,E,z,$,L,M,B;const c=document.getElementById("promo-preview");if(!c)return;const s=((x=document.getElementById("promo-title"))==null?void 0:x.value)||"Sample Title",a=((j=document.getElementById("promo-subtitle"))==null?void 0:j.value)||"",g=((N=document.getElementById("promo-cta-text"))==null?void 0:N.value)||"Shop Now",m=((P=document.getElementById("promo-countdown-enabled"))==null?void 0:P.checked)||!1,h=((E=document.getElementById("promo-close-enabled"))==null?void 0:E.checked)||!1,v=((z=document.getElementById("promo-bg-color"))==null?void 0:z.value)||"#3b82f6",y=(($=document.getElementById("promo-text-color"))==null?void 0:$.value)||"#ffffff",b=((L=document.getElementById("promo-cta-color"))==null?void 0:L.value)||"#ffffff",n=((M=document.getElementById("promo-font-size"))==null?void 0:M.value)||"14px",w=((B=document.getElementById("promo-position"))==null?void 0:B.value)||"top";c.innerHTML=`
                <div style="background: ${v}; color: ${y}; padding: 12px 20px; border-radius: 6px; display: flex; align-items: center; justify-content: space-between; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: ${n};">
                    <div style="display: flex; align-items: center; gap: 20px; flex: 1;">
                        <div>
                            <div style="font-weight: 600;">${s}</div>
                            ${a?`<div style="font-size: 0.85em; opacity: 0.9; margin-top: 2px;">${a}</div>`:""}
                        </div>
                        ${m?'<div style="font-weight: 600; font-family: monospace; font-size: 0.85em;">23:59:59</div>':""}
                        <a href="#" style="background: ${b}; color: ${v}; padding: 8px 16px; border-radius: 4px; text-decoration: none; font-weight: 500; font-size: 0.85em;">${g}</a>
                    </div>
                    ${h?'<button style="background: none; border: none; color: '+y+'; font-size: 18px; cursor: pointer; opacity: 0.7;">×</button>':""}
                </div>
                <div style="margin-top: 10px; font-size: 12px; color: #6b7280; text-align: center;">
                    Position: ${w==="top"?"Top of Page":"Bottom of Page"}
                </div>
            `};document.getElementById("promo-bar-x-topbar-manager")&&window.simpleTopBarManager.init("promo-bar-x-topbar-manager");const l=document.getElementById("promo-bar-x-editor");l&&(window.React&&window.ReactDOM?se(()=>Promise.resolve().then(()=>Fe),void 0).then(c=>{const s=c.default;window.ReactDOM.render(window.React.createElement(s),l)}).catch(c=>{console.error("Error loading editor:",c),e(l)}):e(l)),window.savePromoBar=function(){var h,v,y,b,n,w,x,j,N,P,E,z,$,L,M;console.log("Save button clicked");const s=new URLSearchParams(window.location.search).get("id"),a=((h=document.getElementById("promo-title"))==null?void 0:h.value)||"",g=((v=document.getElementById("promo-name"))==null?void 0:v.value)||"";if(!a.trim()){alert("Please enter a title for the promo bar.");return}if(!g.trim()){alert("Please enter a name for the promo bar.");return}const m={name:g,title:a,subtitle:((y=document.getElementById("promo-subtitle"))==null?void 0:y.value)||"",cta_text:((b=document.getElementById("promo-cta-text"))==null?void 0:b.value)||"",cta_url:((n=document.getElementById("promo-cta-url"))==null?void 0:n.value)||"",countdown_enabled:((w=document.getElementById("promo-countdown-enabled"))==null?void 0:w.checked)||!1,countdown_date:((x=document.getElementById("promo-countdown-date"))==null?void 0:x.value)||"",close_button_enabled:((j=document.getElementById("promo-close-enabled"))==null?void 0:j.checked)||!1,status:((N=document.getElementById("promo-status"))==null?void 0:N.value)||"draft",styling:JSON.stringify({background:((P=document.getElementById("promo-bg-color"))==null?void 0:P.value)||"#3b82f6",color:((E=document.getElementById("promo-text-color"))==null?void 0:E.value)||"#ffffff",font_size:((z=document.getElementById("promo-font-size"))==null?void 0:z.value)||"14px",position:(($=document.getElementById("promo-position"))==null?void 0:$.value)||"top"}),cta_style:JSON.stringify({background:((L=document.getElementById("promo-cta-color"))==null?void 0:L.value)||"#ffffff",color:((M=document.getElementById("promo-bg-color"))==null?void 0:M.value)||"#3b82f6"})};if(s&&(m.id=s),console.log("Data to save:",m),console.log("Admin data:",window.promobarxAdmin),window.promobarxAdmin&&window.promobarxAdmin.ajaxurl){const B=new URLSearchParams;B.append("action","promobarx_save"),B.append("nonce",window.promobarxAdmin.nonce),Object.keys(m).forEach(C=>{B.append(C,m[C])}),console.log("Form data:",B.toString()),fetch(window.promobarxAdmin.ajaxurl,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:B.toString()}).then(C=>(console.log("Response status:",C.status),C.json())).then(C=>{console.log("Save result:",C),C.success?(alert("Promo bar saved successfully!"),window.location.href="admin.php?page=promo-bar-x-topbar-manager"):alert("Error saving promo bar: "+(C.data||"Unknown error"))}).catch(C=>{console.error("Error:",C),alert("Error saving promo bar. Please try again.")})}else console.error("Admin data not available"),alert("Admin data not available. Please refresh the page.")},window.testSave=function(){if(console.log("Test save clicked"),!window.promobarxAdmin||!window.promobarxAdmin.ajaxurl){alert("Admin data not available");return}const c={name:"Test Promo Bar",title:"Test Title",subtitle:"Test Subtitle",cta_text:"Test Button",cta_url:"https://example.com",status:"draft"},s=new URLSearchParams;s.append("action","promobarx_save"),s.append("nonce",window.promobarxAdmin.nonce),Object.keys(c).forEach(a=>{s.append(a,c[a])}),console.log("Test form data:",s.toString()),fetch(window.promobarxAdmin.ajaxurl,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:s.toString()}).then(a=>(console.log("Test response status:",a.status),a.text())).then(a=>{console.log("Test response text:",a);try{const g=JSON.parse(a);console.log("Test parsed result:",g),g.success?alert("Test save successful! ID: "+g.data.id):alert("Test save failed: "+(g.data||"Unknown error"))}catch(g){console.error("Test JSON parse error:",g),alert("Test response not valid JSON: "+a)}}).catch(a=>{console.error("Test error:",a),alert("Test save error: "+a.message)})},window.loadPromoBarData=function(){const s=new URLSearchParams(window.location.search).get("id");if(!s){alert("No promo bar ID found in the URL.");return}if(console.log("Loading promo bar data for ID:",s),window.promobarxAdmin&&window.promobarxAdmin.ajaxurl){const a=new URLSearchParams;a.append("action","promobarx_get_promo_bar"),a.append("nonce",window.promobarxAdmin.nonce),a.append("id",s),console.log("Form data for loading:",a.toString()),fetch(window.promobarxAdmin.ajaxurl,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:a.toString()}).then(g=>(console.log("Load response status:",g.status),g.json())).then(g=>{if(console.log("Load result:",g),g.success&&g.data){const m=g.data;let h={};if(m.styling)try{h=typeof m.styling=="string"?JSON.parse(m.styling):m.styling}catch(b){console.error("Error parsing styling:",b),h={}}let v={};if(m.cta_style)try{v=typeof m.cta_style=="string"?JSON.parse(m.cta_style):m.cta_style}catch(b){console.error("Error parsing CTA style:",b),v={}}document.getElementById("promo-name").value=m.name||"",document.getElementById("promo-title").value=m.title||"",document.getElementById("promo-subtitle").value=m.subtitle||"",document.getElementById("promo-cta-text").value=m.cta_text||"",document.getElementById("promo-cta-url").value=m.cta_url||"",document.getElementById("promo-countdown-enabled").checked=!!m.countdown_enabled,document.getElementById("promo-countdown-date").value=m.countdown_date||"",document.getElementById("promo-close-enabled").checked=!!m.close_button_enabled,document.getElementById("promo-status").value=m.status||"draft",document.getElementById("promo-bg-color").value=h.background||"#3b82f6",document.getElementById("promo-text-color").value=h.color||"#ffffff",document.getElementById("promo-font-size").value=h.font_size||"14px",document.getElementById("promo-position").value=h.position||"top",document.getElementById("promo-cta-color").value=v.background||"#ffffff";const y=document.getElementById("promo-countdown-date");y&&(y.style.display=m.countdown_enabled?"block":"none"),i(),console.log("Successfully loaded promo bar data:",m)}else alert("Error loading promo bar data: "+(g.data||"Unknown error"))}).catch(g=>{console.error("Error loading promo bar data:",g),alert("Error loading promo bar data. Please try again.")})}else console.error("Admin data not available for loading"),alert("Admin data not available for loading. Please refresh the page.")},window.testLoadPromoBar=function(){var a,g;const s=new URLSearchParams(window.location.search).get("id");console.log("Test: Current URL params:",window.location.search),console.log("Test: Promo bar ID from URL:",s),console.log("Test: Admin data available:",{promobarxAdmin:window.promobarxAdmin,ajaxurl:(a=window.promobarxAdmin)==null?void 0:a.ajaxurl,nonce:(g=window.promobarxAdmin)==null?void 0:g.nonce}),s?(console.log("Test: Attempting to load promo bar with ID:",s),loadPromoBarData()):(console.log("Test: No promo bar ID found in URL"),alert("No promo bar ID found in URL. Current URL: "+window.location.href))};const d=document.getElementById("promo-bar-x-dashboard");d&&(d.innerHTML=`
                <div style="display: flex; align-items: center; justify-content: center; height: 256px;">
 ...
 */var I=Symbol.for("react.element"),de=Symbol.for("react.portal"),ce=Symbol.for("react.fragment"),pe=Symbol.for("react.strict_mode"),ue=Symbol.for("react.profiler"),me=Symbol.for("react.provider"),ge=Symbol.for("react.context"),fe=Symbol.for("react.forward_ref"),xe=Symbol.for("react.suspense"),be=Symbol.for("react.memo"),ye=Symbol.for("react.lazy"),Z=Symbol.iterator;function he(e){return e===null||typeof e!="object"?null:(e=Z&&e[Z]||e["@@iterator"],typeof e=="function"?e:null)}var G={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Q=Object.assign,K={};function T(e,o,i){this.props=e,this.context=o,this.refs=K,this.updater=i||G}T.prototype.isReactComponent={},T.prototype.setState=function(e,o){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,o,"setState")},T.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function Y(){}Y.prototype=T.prototype;function F(e,o,i){this.props=e,this.context=o,this.refs=K,this.updater=i||G}var H=F.prototype=new Y;H.constructor=F,Q(H,T.prototype),H.isPureReactComponent=!0;var ee=Array.isArray,te=Object.prototype.hasOwnProperty,J={current:null},oe={key:!0,ref:!0,__self:!0,__source:!0};function re(e,o,i){var r,l={},d=null,p=null;if(o!=null)for(r in o.ref!==void 0&&(p=o.ref),o.key!==void 0&&(d=""+o.key),o)te.call(o,r)&&!oe.hasOwnProperty(r)&&(l[r]=o[r]);var u=arguments.length-2;if(u===1)l.children=i;else if(1<u){for(var c=Array(u),s=0;s<u;s++)c[s]=arguments[s+2];l.children=c}if(e&&e.defaultProps)for(r in u=e.defaultProps,u)l[r]===void 0&&(l[r]=u[r]);return{$$typeof:I,type:e,key:d,ref:p,props:l,_owner:J.current}}function we(e,o){return{$$typeof:I,type:e.type,key:o,ref:e.ref,props:e.props,_owner:e._owner}}function q(e){return typeof e=="object"&&e!==null&&e.$$typeof===I}function ve(e){var o={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(i){return o[i]})}var ne=/\/+/g;function V(e,o){return typeof e=="object"&&e!==null&&e.key!=null?ve(""+e.key):o.toString(36)}function O(e,o,i,r,l){var d=typeof e;(d==="undefined"||d==="boolean")&&(e=null);var p=!1;if(e===null)p=!0;else switch(d){case"string":case"number":p=!0;break;case"object":switch(e.$$typeof){case I:case de:p=!0}}if(p)return p=e,l=l(p),e=r===""?"."+V(p,0):r,ee(l)?(i="",e!=null&&(i=e.replace(ne,"$&/")+"/"),O(l,o,i,"",function(s){return s})):l!=null&&(q(l)&&(l=we(l,i+(!l.key||p&&p.key===l.key?"":(""+l.key).replace(ne,"$&/")+"/")+e)),o.push(l)),1;if(p=0,r=r===""?".":r+":",ee(e))for(var u=0;u<e.length;u++){d=e[u];var c=r+V(d,u);p+=O(d,o,i,c,l)}else if(c=he(e),typeof c=="function")for(e=c.call(e),u=0;!(d=e.next()).done;)d=d.value,c=r+V(d,u++),p+=O(d,o,i,c,l);else if(d==="object")throw o=String(e),Error("Objects are not valid as a React child (found: "+(o==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":o)+"). If you meant to render a collection of children, use an array instead.");return p}function D(e,o,i){if(e==null)return e;var r=[],l=0;return O(e,r,"","",function(d){return o.call(i,d,l++)}),r}function ke(e){if(e._status===-1){var o=e._result;o=o(),o.then(function(i){(e._status===0||e._status===-1)&&(e._status=1,e._result=i)},function(i){(e._status===0||e._status===-1)&&(e._status=2,e._result=i)}),e._status===-1&&(e._status=0,e._result=o)}if(e._status===1)return e._result.default;throw e._result}var _={current:null},U={transition:null},_e={ReactCurrentDispatcher:_,ReactCurrentBatchConfig:U,ReactCurrentOwner:J};function ae(){throw Error("act(...) is not supported in production builds of React.")}f.Children={map:D,forEach:function(e,o,i){D(e,function(){o.apply(this,arguments)},i)},count:function(e){var o=0;return D(e,function(){o++}),o},toArray:function(e){return D(e,function(o){return o})||[]},only:function(e){if(!q(e))throw Error("React.Children.only expected to receive a single React element child.");return e}},f.Component=T,f.Fragment=ce,f.Profiler=ue,f.PureComponent=F,f.StrictMode=pe,f.Suspense=xe,f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=_e,f.act=ae,f.cloneElement=function(e,o,i){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var r=Q({},e.props),l=e.key,d=e.ref,p=e._owner;if(o!=null){if(o.ref!==void 0&&(d=o.ref,p=J.current),o.key!==void 0&&(l=""+o.key),e.type&&e.type.defaultProps)var u=e.type.defaultProps;for(c in o)te.call(o,c)&&!oe.hasOwnProperty(c)&&(r[c]=o[c]===void 0&&u!==void 0?u[c]:o[c])}var c=arguments.length-2;if(c===1)r.children=i;else if(1<c){u=Array(c);for(var s=0;s<c;s++)u[s]=arguments[s+2];r.children=u}return{$$typeof:I,type:e.type,key:l,ref:d,props:r,_owner:p}},f.createContext=function(e){return e={$$typeof:ge,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:me,_context:e},e.Consumer=e},f.createElement=re,f.createFactory=function(e){var o=re.bind(null,e);return o.type=e,o},f.createRef=function(){return{current:null}},f.forwardRef=function(e){return{$$typeof:fe,render:e}},f.isValidElement=q,f.lazy=function(e){return{$$typeof:ye,_payload:{_status:-1,_result:e},_init:ke}},f.memo=function(e,o){return{$$typeof:be,type:e,compare:o===void 0?null:o}},f.startTransition=function(e){var o=U.transition;U.transition={};try{e()}finally{U.transition=o}},f.unstable_act=ae,f.useCallback=function(e,o){return _.current.useCallback(e,o)},f.useContext=function(e){return _.current.useContext(e)},f.useDebugValue=function(){},f.useDeferredValue=function(e){return _.current.useDeferredValue(e)},f.useEffect=function(e,o){return _.current.useEffect(e,o)},f.useId=function(){return _.current.useId()},f.useImperativeHandle=function(e,o,i){return _.current.useImperativeHandle(e,o,i)},f.useInsertionEffect=function(e,o){return _.current.useInsertionEffect(e,o)},f.useLayoutEffect=function(e,o){return _.current.useLayoutEffect(e,o)},f.useMemo=function(e,o){return _.current.useMemo(e,o)},f.useReducer=function(e,o,i){return _.current.useReducer(e,o,i)},f.useRef=function(e){return _.current.useRef(e)},f.useState=function(e){return _.current.useState(e)},f.useSyncExternalStore=function(e,o,i){return _.current.useSyncExternalStore(e,o,i)},f.useTransition=function(){return _.current.useTransition()},f.version="18.3.1",X.exports=f;var k=X.exports;/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var je=k,Ee=Symbol.for("react.element"),Ce=Symbol.for("react.fragment"),Ne=Object.prototype.hasOwnProperty,Se=je.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Pe={key:!0,ref:!0,__self:!0,__source:!0};function ie(e,o,i){var r,l={},d=null,p=null;i!==void 0&&(d=""+i),o.key!==void 0&&(d=""+o.key),o.ref!==void 0&&(p=o.ref);for(r in o)Ne.call(o,r)&&!Pe.hasOwnProperty(r)&&(l[r]=o[r]);if(e&&e.defaultProps)for(r in o=e.defaultProps,o)l[r]===void 0&&(l[r]=o[r]);return{$$typeof:Ee,type:e,key:d,ref:p,props:l,_owner:Se.current}}R.Fragment=Ce,R.jsx=ie,R.jsxs=ie,W.exports=R;var t=W.exports;/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Be=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),le=(...e)=>e.filter((o,i,r)=>!!o&&o.trim()!==""&&r.indexOf(o)===i).join(" ").trim();/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ie=k.forwardRef(({color:e="currentColor",size:o=24,strokeWidth:i=2,absoluteStrokeWidth:r,className:l="",children:d,iconNode:p,...u},c)=>k.createElement("svg",{ref:c,...Te,width:o,height:o,stroke:e,strokeWidth:r?Number(i)*24/Number(o):i,className:le("lucide",l),...u},[...p.map(([s,a])=>k.createElement(s,a)),...Array.isArray(d)?d:[d]]));/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S=(e,o)=>{const i=k.forwardRef(({className:r,...l},d)=>k.createElement(Ie,{ref:d,iconNode:o,className:le(`lucide-${Be(e)}`,r),...l}));return i.displayName=`${e}`,i};/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ze=S("Eye",[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $e=S("MousePointer",[["path",{d:"M12.586 12.586 19 19",key:"ea5xo7"}],["path",{d:"M3.688 3.037a.497.497 0 0 0-.651.651l6.5 15.999a.501.501 0 0 0 .947-.062l1.569-6.083a2 2 0 0 1 1.448-1.479l6.124-1.579a.5.5 0 0 0 .063-.947z",key:"277e5u"}]]);/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
