(function(){"use strict";function se(e,o){for(var i=0;i<o.length;i++){const r=o[i];if(typeof r!="string"&&!Array.isArray(r)){for(const a in r)if(a!=="default"&&!(a in e)){const s=Object.getOwnPropertyDescriptor(r,a);s&&Object.defineProperty(e,a,s.get?s:{enumerable:!0,get:()=>r[a]})}}}return Object.freeze(Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}))}const Ve="modulepreload",We=function(e){return"/"+e},Xe={},le=function(o,i,r){let a=Promise.resolve();function s(p){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=p,window.dispatchEvent(u),!u.defaultPrevented)throw p}return a.then(p=>{for(const u of p||[])u.status==="rejected"&&s(u.reason);return o().catch(s)})};(function(){let e={promoBars:[],loading:!0,activeTab:"manage"},o=null;function i(g){if(o=document.getElementById(g),!o){console.error("Container not found:",g);return}r(),window.promobarxAdmin&&window.promobarxAdmin.ajaxurl&&window.promobarxAdmin.nonce?a():(console.log("Admin data not available"),e.loading=!1,v())}function r(){o.innerHTML=`
        ...
        `}window.simpleTopBarManager={init:i,loadPromoBars:a,deletePromoBar:s,toggleStatus:p,createNew:u,editPromoBar:d,switchTab:c}})(),document.addEventListener("DOMContentLoaded",()=>{try{let e=function(d){d.innerHTML=`
            ...
            `)}catch(e){console.error("Error initializing PromoBarX components:",e),document.querySelectorAll('[id*="promo-bar-x"]').forEach(i=>{i.innerHTML===""&&(i.innerHTML=`
                ...
                `)})}});function de(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function ce(e){if(e.__esModule)return e;var o=e.default;if(typeof o=="function"){var i=function r(){return this instanceof r?Reflect.construct(o,arguments,this.constructor):o.apply(this,arguments)};i.prototype=o.prototype}else i={};return Object.defineProperty(i,"__esModule",{value:!0}),Object.keys(e).forEach(function(r){var a=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(i,r,a.get?a:{enumerable:!0,get:function(){return e[r]}})}),i}var J={exports:{}},O={},V={exports:{}},m={};/**
 * @license React
 ...
 */var P=Symbol.for("react.element"),pe=Symbol.for("react.portal"),ue=Symbol.for("react.fragment"),me=Symbol.for("react.strict_mode"),fe=Symbol.for("react.profiler"),xe=Symbol.for("react.provider"),ge=Symbol.for("react.context"),be=Symbol.for("react.forward_ref"),ye=Symbol.for("react.suspense"),he=Symbol.for("react.memo"),ve=Symbol.for("react.lazy"),W=Symbol.iterator;function we(e){return e===null||typeof e!="object"?null:(e=W&&e[W]||e["@@iterator"],typeof e=="function"?e:null)}var X={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Z=Object.assign,G={};function S(e,o,i){this.props=e,this.context=o,this.refs=G,this.updater=i||X}S.prototype.isReactComponent={},S.prototype.setState=function(e,o){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,o,"setState")},S.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function Q(){}Q.prototype=S.prototype;function D(e,o,i){this.props=e,this.context=o,this.refs=G,this.updater=i||X}var F=D.prototype=new Q;F.constructor=D,Z(F,S.prototype),F.isPureReactComponent=!0;var K=Array.isArray,Y=Object.prototype.hasOwnProperty,H={current:null},ee={key:!0,ref:!0,__self:!0,__source:!0};function te(e,o,i){var r,a={},s=null,p=null;if(o!=null)for(r in o.ref!==void 0&&(p=o.ref),o.key!==void 0&&(s=""+o.key),o)Y.call(o,r)&&!ee.hasOwnProperty(r)&&(a[r]=o[r]);var u=arguments.length-2;if(u===1)a.children=i;else if(1<u){for(var d=Array(u),c=0;c<u;c++)d[c]=arguments[c+2];a.children=d}if(e&&e.defaultProps)for(r in u=e.defaultProps,u)a[r]===void 0&&(a[r]=u[r]);return{$$typeof:P,type:e,key:s,ref:p,props:a,_owner:H.current}}function ke(e,o){return{$$typeof:P,type:e.type,key:o,ref:e.ref,props:e.props,_owner:e._owner}}function U(e){return typeof e=="object"&&e!==null&&e.$$typeof===P}function je(e){var o={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(i){return o[i]})}var oe=/\/+/g;function q(e,o){return typeof e=="object"&&e!==null&&e.key!=null?je(""+e.key):o.toString(36)}function I(e,o,i,r,a){var s=typeof e;(s==="undefined"||s==="boolean")&&(e=null);var p=!1;if(e===null)p=!0;else switch(s){case"string":case"number":p=!0;break;case"object":switch(e.$$typeof){case P:case pe:p=!0}}if(p)return p=e,a=a(p),e=r===""?"."+q(p,0):r,K(a)?(i="",e!=null&&(i=e.replace(oe,"$&/")+"/"),I(a,o,i,"",function(c){return c})):a!=null&&(U(a)&&(a=ke(a,i+(!a.key||p&&p.key===a.key?"":(""+a.key).replace(oe,"$&/")+"/")+e)),o.push(a)),1;if(p=0,r=r===""?".":r+":",K(e))for(var u=0;u<e.length;u++){s=e[u];var d=r+q(s,u);p+=I(s,o,i,d,a)}else if(d=we(e),typeof d=="function")for(e=d.call(e),u=0;!(s=e.next()).done;)s=s.value,d=r+q(s,u++),p+=I(s,o,i,d,a);else if(s==="object")throw o=String(e),Error("Objects are not valid as a React child (found: "+(o==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":o)+"). If you meant to render a collection of children, use an array instead.");return p}function L(e,o,i){if(e==null)return e;var r=[],a=0;return I(e,r,"","",function(s){return o.call(i,s,a++)}),r}function _e(e){if(e._status===-1){var o=e._result;o=o(),o.then(function(i){(e._status===0||e._status===-1)&&(e._status=1,e._result=i)},function(i){(e._status===0||e._status===-1)&&(e._status=2,e._result=i)}),e._status===-1&&(e._status=0,e._result=o)}if(e._status===1)return e._result.default;throw e._result}var w={current:null},R={transition:null},Ce={ReactCurrentDispatcher:w,ReactCurrentBatchConfig:R,ReactCurrentOwner:H};function re(){throw Error("act(...) is not supported in production builds of React.")}m.Children={map:L,forEach:function(e,o,i){L(e,function(){o.apply(this,arguments)},i)},count:function(e){var o=0;return L(e,function(){o++}),o},toArray:function(e){return L(e,function(o){return o})||[]},only:function(e){if(!U(e))throw Error("React.Children.only expected to receive a single React element child.");return e}},m.Component=S,m.Fragment=ue,m.Profiler=fe,m.PureComponent=D,m.StrictMode=me,m.Suspense=ye,m.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Ce,m.act=re,m.cloneElement=function(e,o,i){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var r=Z({},e.props),a=e.key,s=e.ref,p=e._owner;if(o!=null){if(o.ref!==void 0&&(s=o.ref,p=H.current),o.key!==void 0&&(a=""+o.key),e.type&&e.type.defaultProps)var u=e.type.defaultProps;for(d in o)Y.call(o,d)&&!ee.hasOwnProperty(d)&&(r[d]=o[d]===void 0&&u!==void 0?u[d]:o[d])}var d=arguments.length-2;if(d===1)r.children=i;else if(1<d){u=Array(d);for(var c=0;c<d;c++)u[c]=arguments[c+2];r.children=u}return{$$typeof:P,type:e.type,key:a,ref:s,props:r,_owner:p}},m.createContext=function(e){return e={$$typeof:ge,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:xe,_context:e},e.Consumer=e},m.createElement=te,m.createFactory=function(e){var o=te.bind(null,e);return o.type=e,o},m.createRef=function(){return{current:null}},m.forwardRef=function(e){return{$$typeof:be,render:e}},m.isValidElement=U,m.lazy=function(e){return{$$typeof:ve,_payload:{_status:-1,_result:e},_init:_e}},m.memo=function(e,o){return{$$typeof:he,type:e,compare:o===void 0?null:o}},m.startTransition=function(e){var o=R.transition;R.transition={};try{e()}finally{R.transition=o}},m.unstable_act=re,m.useCallback=function(e,o){return w.current.useCallback(e,o)},m.useContext=function(e){return w.current.useContext(e)},m.useDebugValue=function(){},m.useDeferredValue=function(e){return w.current.useDeferredValue(e)},m.useEffect=function(e,o){return w.current.useEffect(e,o)},m.useId=function(){return w.current.useId()},m.useImperativeHandle=function(e,o,i){return w.current.useImperativeHandle(e,o,i)},m.useInsertionEffect=function(e,o){return w.current.useInsertionEffect(e,o)},m.useLayoutEffect=function(e,o){return w.current.useLayoutEffect(e,o)},m.useMemo=function(e,o){return w.current.useMemo(e,o)},m.useReducer=function(e,o,i){return w.current.useReducer(e,o,i)},m.useRef=function(e){return w.current.useRef(e)},m.useState=function(e){return w.current.useState(e)},m.useSyncExternalStore=function(e,o,i){return w.current.useSyncExternalStore(e,o,i)},m.useTransition=function(){return w.current.useTransition()},m.version="18.3.1",V.exports=m;var h=V.exports;const Ne=ce(se({__proto__:null,default:de(h)},[h]));/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ee=Ne,Se=Symbol.for("react.element"),Pe=Symbol.for("react.fragment"),Te=Object.prototype.hasOwnProperty,Be=Ee.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,ze={key:!0,ref:!0,__self:!0,__source:!0};function ne(e,o,i){var r,a={},s=null,p=null;i!==void 0&&(s=""+i),o.key!==void 0&&(s=""+o.key),o.ref!==void 0&&(p=o.ref);for(r in o)Te.call(o,r)&&!ze.hasOwnProperty(r)&&(a[r]=o[r]);if(e&&e.defaultProps)for(r in o=e.defaultProps,o)a[r]===void 0&&(a[r]=o[r]);return{$$typeof:Se,type:e,key:s,ref:p,props:a,_owner:Be.current}}O.Fragment=Pe,O.jsx=ne,O.jsxs=ne,J.exports=O;var t=J.exports;/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $e=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),ie=(...e)=>e.filter((o,i,r)=>!!o&&o.trim()!==""&&r.indexOf(o)===i).join(" ").trim();/**
 * @license lucide-react v0.469.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
