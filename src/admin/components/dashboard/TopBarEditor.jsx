...
const TopBarEditor = ({ promoBar, onClose, onSave }) => {
    ...
    const tabs = [
        ...
        { id: 'pages', label: 'Page Assignment', icon: MapPin },
                    ...
                    <div className="w-1/2 border-r border-gray-200 flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto p-6">
                            ...
                            {activeTab === 'pages' && (
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-lg font-medium text-gray-900 mb-4">Page Assignment</h3>
                                        <p className="text-gray-600 mb-4">
                                            Choose which pages this promo bar should appear on. You can assign it globally, 
                                            to specific pages, post types, categories, or custom URL patterns.
                                        </p>
                                        <button
                                            onClick={() => setShowPageAssignment(true)}
                                            className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 flex items-center"
                                        >
                                            <MapPin className="w-4 h-4 mr-2" />
                                            Manage Page Assignments
                                        </button>
                                    </div>
                                </div>
                            )}
